...
Filters.gaussianBlur2 = function(pixels, kernelSize, sigma) {
  var x, y, neighbors;
  var kernel = generateKernel(sigma, kernelSize);

  for (y = 0; y < this.height; y++) {
    for (x = 0; x < this.width; x++) {
      neighbors = this.buildMatrix(x, y, size);
      GBlur_iter(neighbors, x, y)
    }
  }
};
